    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientSkus", x => x.Id);
                    table.CheckConstraint("CK_IngredientSkus", "[Stock] >= 0");
                    table.ForeignKey(
                        name: "FK_IngredientSkus_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ProductSkus", "[Stock] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Inspiration = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    PublicId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "newid()"),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "sysdatetime()"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_RecipeSteps", "[StepNumber] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ingredients_PublicId",
                table: "Ingredients",
                column: "PublicId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_IngredientSkus_IngredientId",
                table: "IngredientSkus",
                column: "IngredientId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_IngredientSkus_PublicId",
                table: "IngredientSkus",
                column: "PublicId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeIngredients_PublicId",
                table: "RecipeIngredients",
                column: "PublicId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransactions_PublicId",
